...
# A tool by nitrp from github.com/sd-abubakar
...
echo -e "$red                      ▶ SnapBack Coded by$grn sdabubakar$red ◀$rset"
echo -e "$red                 ⫸$ylo Follow me on Instagram- @s.d_abubakarrr$red ⫷$rset"
echo 

# Functions
echo -e "$red              
[NOTE:- NEED INTERNET CONNECTION FOR BACKUP]$rset"


echo -e "$grn              
＞＞＞＞>>>＞$ylo [Options]$grn ＜<<<＜＜＜＜$rset"

echo -e "$red                   
➡$cyan [1️⃣] Termux backup"
echo -e "$red                   
➡$cyan [2️⃣] Termux restore"
echo -e "$red                   
➡$cyan [3️⃣] Update script"
echo -e "$red                   
➡$cyan [4️⃣] Exit"
echo " "
echo " "
...
echo " "
echo -e "$cyan                   
[[[$ylo Select any option$cyan]]]$rset"
echo " "
read n
case "$n" in
1)echo " "
...
echo " "
echo -e "$cyan            click$grn ENTER$cyan to go back into snapback menu$rset"
echo " "
read punch
fi
cd $HOME/snapback
